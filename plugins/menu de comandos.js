...
conn.send3ButtonImg(m.chat, pp, menu, '™𝓝𝓮𝓚𝓸𝓼𝓶𝓲𝓬 - 𝓑𝓞𝓣', '👑𝙼𝙴𝙽𝚄 𝚂𝙸𝙼𝙿𝙻𝙴👑', `#menusimple`, '👑𝙼𝙴𝙽𝚄 𝙰𝚄𝙳𝙸𝙾𝚂👑', `#menuaudios`, '👑𝙶𝚁𝚄𝙿𝙾𝚂 𝙾𝙵𝙸𝙲𝙸𝙰𝙻𝙴𝚂👑', `#grupos`, '👑𝚁𝙴𝙳𝙴𝚂👑', `#Redes`, m, false, { contextInfo: { mentionedJid }})   
